...
// Archived Vite-native landing implementation.
// The active main landing now comes from public/embedded/noos-landing.
...
import { AI_OBJET_URL, publicAsset } from "../../lib/env";
      ...
      <div className="w-full min-h-screen relative z-10">
        ...
        >
          <div className="mx-auto flex w-full max-w-[1920px] items-center justify-between px-4 md:px-8 lg:px-12">
            ...
            >
              <NoosLogo className="h-8 w-[162px] text-white transition-transform duration-300 hover:scale-105" />
            </motion.div>
          ...
          >
            ...
            >
              <motion.button
                ...
                className="inline-flex min-h-[46px] cursor-pointer items-center justify-center rounded-[999px] border border-[rgba(255,255,255,0.14)] bg-[rgba(255,255,255,0.08)] px-6 py-3 font-cardinal-fruit text-[13px] tracking-[0.04em] text-[rgba(255,255,255,0.82)] backdrop-blur-[5px] transition-all duration-300 hover:border-[rgba(255,255,255,0.24)] hover:bg-[rgba(255,255,255,0.12)] hover:shadow-lg hover:shadow-white/10 md:text-[14px]"
              ...
              <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.98 }}>
                <a
                  href={AI_OBJET_URL}
                  className="inline-flex min-h-[46px] items-center justify-center rounded-[999px] border border-[rgba(241,201,125,0.36)] bg-[linear-gradient(135deg,rgba(255,248,232,0.16),rgba(241,201,125,0.08))] px-6 py-3 font-cardinal-fruit text-[13px] tracking-[0.04em] text-[rgba(255,238,202,0.92)] shadow-[0_18px_54px_rgba(241,201,125,0.14)] backdrop-blur-[5px] transition-all duration-300 hover:border-[rgba(241,201,125,0.58)] hover:bg-[linear-gradient(135deg,rgba(255,248,232,0.22),rgba(127,216,255,0.10))] md:text-[14px]"
                >
                  Explore AI Objet
                </a>
              </motion.div>
    ...
    <section className="bg-black relative min-h-screen overflow-hidden">
      ...
      <div className="relative z-10 max-w-[1512px] mx-auto px-4 h-full flex items-center justify-center">
        <div className="flex flex-col items-center text-center">
          ...
          >
            <NoosLogo className="h-16 w-[324px] text-white md:h-20 md:w-[405px] lg:h-24 lg:w-[486px]" />
          </motion.div>
        </div>
      </div>
    </section>
      ...
      <div className="max-w-[1220px] mx-auto px-4">
        ...
        >
          ...
          >
            ...
            >
              <NoosLogo className="h-9 w-[182px] text-white md:h-10 md:w-[203px] lg:h-12 lg:w-[244px]" />
            </motion.h3>
            <motion.p
...
const PRICING_PLANS = [
  {
    ...
    name: "Basic",
    price: "Free",
    description: "NOOS 핵심 흐름을 가볍게 시작하는 플랜",
...
const TransitionVeil = ({ active = true, label = "NOOS" }) => {
  return (
    <motion.div
      aria-hidden="true"
...
function App() {
  ...
  const startsOnLogin =
    initialParams.get("login") === "start" || initialParams.get("login") === "success";
  const startsOnMain = initialParams.get("main") === "true";
    ...
    return (
      ...
      >
        <motion.div
          ...
          animate={{ opacity: isLoginTransitioning ? 0 : 1, scale: isLoginTransitioning ? 0.98 : 1 }}
          exit={{ opacity: 0, scale: 0.95 }}
          transition={{ duration: 0.52, ease: [0.76, 0, 0.24, 1] }}
        >
          <Login onBack={handleBackFromLogin} onNavigate={handleNavigateFromLogin} />
        </motion.div>
        {isLoginTransitioning && <TransitionVeil label="NOOS" />}
      </ClickSpark>
    );
  }
  ...
  if (showFirstLook) {
    return (
      ...
      >
        ...
        {isTransitioning && <TransitionVeil label="NOOS" />}
      </ClickSpark>
    );
  }
  ...
  return (
    ...
    >
      <motion.div
        className="App bg-black text-white h-screen overflow-hidden"
        initial={{ opacity: 0 }}

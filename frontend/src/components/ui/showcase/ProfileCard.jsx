...
const Card = ({ colorScheme = "purple", name = "MikeAndrewDesigner", role = "UI / EX Designer" }) => {
  const getGradient = (scheme) => {
    switch(scheme) {
      case "purple":
        return "linear-gradient(744deg,#af40ff,#5b42f3 60%,#00ddeb)";
      case "green":
        return "linear-gradient(744deg,#40ff88,#42f35b 60%,#00ebdd)";
      case "orange":
        return "linear-gradient(744deg,#ff8040,#f3935b 60%,#eb7700)";
      case "pink":
        return "linear-gradient(744deg,#ff4088,#f35bb4 60%,#eb0077)";
      default:
        return "linear-gradient(744deg,#af40ff,#5b42f3 60%,#00ddeb)";
    }
  };
  ...
  return (
    <StyledWrapper gradient={getGradient(colorScheme)}>

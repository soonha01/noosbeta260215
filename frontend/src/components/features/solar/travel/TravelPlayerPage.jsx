...
import {
  PLAYER_SESSION_GUIDE_STEPS,
  buildCurrentStateCards,
  buildSessionRows,
  buildTargetStateCards,
  formatAxisName,
...
const TravelPlayerPage = ({
  ...
  const liveMuseStatusLabel = getLiveMuseStatusLabel(liveMuseStatus);
  ...
  const sessionGuideCopy = getSessionGuideCopy(generatedJourney);
  const currentStateCards = buildCurrentStateCards(currentStateAxes);
  const targetStateCards = buildTargetStateCards(targetStateAxes);

  const sessionRows = useMemo(() => {
    return buildSessionRows(transitionPhases, planetMedia, durationSec);
              ...
              <RightPanel>
                <PanelScroll>
                  ...
                  <GlassPanel>
                    ...
                    <LiveEegWaveChart readings={liveMuseReadings} />
                  ...
                  <GlassPanel>
                    <PanelHeader>
                      ...
                      <BodyText>{sessionGuideCopy}</BodyText>
                    </PanelHeader>
                    <InsightList>
                      {PLAYER_SESSION_GUIDE_STEPS.map((step) => (

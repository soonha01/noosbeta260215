...
const getLiveReadingValue = (reading, channelKey) => {
...
const createLiveWavePath = ({ samples, baselineY, rowAmplitude, amplitude, plotLeft, plotWidth }) => {

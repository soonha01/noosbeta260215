...
const titleItems = [
  ...
  { type: "text", value: "빛과 음악으로 환경 조성." },
  { type: "text", value: "실제 부품들을 고려한 설계." },
      ...
      <div ref={descriptionRef} className="px-6 pt-8 pb-20 md:px-12 md:pt-12 md:pb-28 lg:px-20 lg:pt-16 lg:pb-36">
        <div className="text-center">
          ...
          <p className="mt-8 leading-relaxed text-muted-foreground text-3xl text-center">
            {("NOOS AI Objet는 Muse EEG와 설문으로 파악한 사용자의 상태를 음악, 조명, 환경 개입으로 이어 주는 물리적 인터페이스입니다. 외형은 RGB 블루투스 스피커처럼 보이지만 내부는 Jetson Nano, ESP32, RGBW 디퓨저, 오디오, 전원, 흡배기, 서비스 접근을 담기위해 설계되었습니다.").split(" ").map((word, index, array) => {

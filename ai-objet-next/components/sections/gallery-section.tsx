...
export function GallerySection() {
  ...
  const images = [
    { src: "/images/noos-home-gallery-01.png", alt: "NOOS AI Objet 거실 콘솔 배치 렌더" },
    { src: "/images/noos-home-gallery-02.png", alt: "NOOS AI Objet 침대 옆 협탁 배치 렌더" },
    { src: "/images/noos-home-gallery-03.png", alt: "NOOS AI Objet 홈오피스 데스크 배치 렌더" },
  ];

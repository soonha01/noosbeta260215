...
NOOS의 전체 흐름을 간단히 보여주는 동작 시연 영상입니다. 로그인 이후 기기 보유 여부 확인, Muse S Athena 연결 또는 설문 측정, 행성 선택, 음악 재생, 실시간 뇌파 스트림 확인까지 이어지는 흐름을 볼 수 있습니다.

<video src="./docs/portfolio/noos-demo.mp4" controls width="100%"></video>

영상이 바로 보이지 않는 경우 [동작 시연 영상 보기](./docs/portfolio/noos-demo.mp4)를 클릭하면 됩니다.
